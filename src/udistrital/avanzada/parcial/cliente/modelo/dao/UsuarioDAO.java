 ...
 * 
 * <p>Esta clase implementa el patrón DAO, proporcionando una abstracción
 * entre la lógica de negocio y la capa de persistencia de datos. Permite
 * realizar operaciones como insertar, buscar, actualizar y eliminar usuarios
 * sin que el resto de la aplicación conozca los detalles de la implementación
...
public class UsuarioDAO implements IUsuarioDAO {
     ...
     * 
     * <p>Verifica que el usuario exista y que la contraseña proporcionada
     * coincida con la almacenada en la base de datos.</p>
     * 
