...
/**
 * Clase que gestiona la carga de configuración del cliente desde un archivo properties.
 * 
 * <p>Esta clase permite cargar la configuración necesaria para que el cliente
 * se conecte al servidor, incluyendo el host, puerto y credenciales de usuarios
 * disponibles. Utiliza la clase Properties de Java para leer archivos .properties.</p>
 * 
...
public class ConfiguracionCliente {
     ...
     * 
     * <p>Lee el archivo properties y extrae los valores de host y puerto
     ...
     * @return true si el usuario existe en el archivo properties, false en caso contrario
     */
