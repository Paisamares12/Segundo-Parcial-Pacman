 ...
 * los resultados en {@link ClienteEstado}. Gestiona la autenticación del
 * usuario antes de permitir el inicio del juego.</p>
 *
...
public class ControlCliente {
     ...
     *
     * @param estado objeto ClienteEstado que mantiene el estado observable del
     * cliente
     */
     ...
     *
     * <p>
     * Este método establece la conexión TCP con el servidor, envía las
     * credenciales del usuario para autenticación y, si la autenticación es
     * exitosa, inicia un hilo para escuchar actualizaciones del tablero de
     * juego.</p>
     *
     * <p>
     * Si la autenticación falla, cierra la conexión y deshabilita los
     * movimientos.</p>
     *
    ...
    /**
     * Inicia el hilo que escucha los snapshots del tablero enviados por el
     * servidor.
     *
     * <p>
     * Este hilo se ejecuta continuamente mientras la conexión esté activa,
     * recibiendo objetos SnapshotTablero y actualizando el estado del
     * cliente.</p>
     */
