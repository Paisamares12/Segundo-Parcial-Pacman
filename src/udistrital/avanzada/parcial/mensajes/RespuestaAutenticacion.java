...
/**
 * Clase que representa la respuesta del servidor a una solicitud de autenticación.
 * 
 * <p>Esta clase encapsula el resultado de la validación de credenciales,
 * indicando si la autenticación fue exitosa y proporcionando un mensaje
 * descriptivo del resultado.</p>
 * 
...
public class RespuestaAutenticacion implements Serializable {
     ...
     * 
     * @param exitosa true si la autenticación fue exitosa, false en caso contrario
