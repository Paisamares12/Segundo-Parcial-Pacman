 ...
 *
 * <p>
 * Esta interfaz permite diferentes implementaciones de manejadores de clientes,
 * facilitando el testing y la extensibilidad del sistema.</p>
 *
 * <p>
 * Cumple con:</p>
 * <ul>
 * <li><b>I - Interface Segregation:</b> Interfaz específica para manejo de
 * clientes</li>
 * <li><b>D - Dependency Inversion:</b> El servidor depende de esta
 * abstracción</li>
 * </ul>
 *
