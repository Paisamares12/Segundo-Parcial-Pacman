 ...
 *
 * <p>
 * Encapsula su posición actual en el tablero y la dirección hacia la cual se
 * está moviendo. La clase no se encarga del movimiento en sí, solo de mantener
 * el estado actual de Pac-Man, que será actualizado por el
 * {@link udistrital.avanzada.parcial.servidor.control.ControlJuego}.</p>
 *
 * <p>
 * Esta clase cumple con el principio de responsabilidad única (SRP): solo
 * gestiona la posición y la dirección del personaje.</p>
 * <p>
...
public class Pacman {
    ...
    /**
     * Crea un Pac-Man en la posición inicial por defecto (100, 100) y sin
     * dirección activa.
     */
    public Pacman() {
     ...
     *
     * @param direccion nueva dirección, o {@link Direccion#NINGUNA} para
     * detenerlo
     */
    ...
    /**
     * Mueve a Pac-Man una unidad en la dirección actual, aplicando un paso
     * dado. Este método no valida colisiones ni límites (eso lo hace el
     * controlador).
     *
