 ...
 *
 * <p>
 * Esta interfaz abstrae la lógica de negocio relacionada con la autenticación,
 * permitiendo diferentes implementaciones y facilitando el testing.</p>
 *
 * <p>
 * Cumple con:</p>
 * <ul>
 * <li><b>I - Interface Segregation:</b> Interfaz específica para
 * autenticación</li>
 * <li><b>D - Dependency Inversion:</b> Los controladores dependen de esta
 * abstracción</li>
 * </ul>
 *
...
public interface IAutenticacionService {
     ...
     *
     * <p>
     * Este método encapsula toda la lógica de negocio relacionada con la
     * autenticación, incluyendo validación de credenciales, generación de
     * respuestas y cualquier otra regla de negocio.</p>
     *
